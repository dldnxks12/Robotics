...
class CustomDriver:
    ...
    def process_lidar(self, ranges, coordinate):
        ...
        if x_map > 1580 - 30 and x_map < 1580 + 40:
            if y_map > (2000 - 920) - 60 and y_map < (2000 - 920) + 50:
                steering_angle = -0.15

        if x_map < 1100 and x_map > 900:
            if y_map > (2000 - 1190) - 50 and y_map < (2000 - 1190) + 20:
                steering_angle = -0.11
        ...
        print(f"Final : {self.Final} | SemiFinal : {self.SemiFinal} ", end='\r')
